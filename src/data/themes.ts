...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    headline: "Drug safety in pregnancy",
    story: "Drug safety in populations that are chronically under-represented in trials. The 2026 JAMA Internal Medicine study of benzodiazepine use during pregnancy from Taiwan's NHIRD typifies AsPEN's work in this area, alongside the 2024 Nature Medicine analysis of 3.6 million mother-child pairs, lithium prescribing across 14 countries, and global trends in pregnancy opioid use.",
    highlightPmid: "41428288",
    coverVisual: "dots",
  ...
  },
  {
    ...
    story: "Polypharmacy, falls, and hip fracture; questions where Asian healthcare systems with universal coverage offer some of the cleanest population-level evidence anywhere. The 2023 BMJ case-case-time-control study of anticholinergic burden and acute cardiovascular events typifies AsPEN's approach to medication safety in older adults.",
    highlightPmid: "37758279",
    coverVisual: "cluster",
    tags: ["older adults", "polypharmacy", "falls", "hip fracture", "anticholinergic"],
  },
  {
    id: "cardiovascular",
    number: "08",
    ...
    story: "Cardiovascular safety as a downstream outcome; heart failure, myocardial infarction, sudden cardiac arrest, and broader cardiometabolic risk associated with psychotropics, ADHD medications, antidiabetic drugs, and anticholinergic burden studied across AsPEN sites. The 2025 European Heart Journal case-crossover study of transient anticholinergic burden and out-of-hospital cardiac arrest is the most recent example.",
    highlightPmid: "40996095",
    coverVisual: "wave",
